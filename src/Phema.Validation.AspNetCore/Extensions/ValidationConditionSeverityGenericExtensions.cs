...
{
	public static class ValidationConditionSeverityGenericExtensions
	{
		public static IValidationError AddError<TValidationComponent>(this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage> selector)
		...
		public static IValidationError AddWarning<TValidationComponent>(this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage> selector)
			where TValidationComponent : IValidationComponent
		{
			var provider = (IServiceProvider)condition;
		...
		public static IValidationError AddInformation<TValidationComponent>(this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage> selector)
			where TValidationComponent : IValidationComponent
		{
			var provider = (IServiceProvider)condition;
		...
		public static IValidationError AddDebug<TValidationComponent>(this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage> selector)
			where TValidationComponent : IValidationComponent
		{
			var provider = (IServiceProvider)condition;
		...
		public static IValidationError AddTrace<TValidationComponent>(this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage> selector)
			where TValidationComponent : IValidationComponent
		{
			var provider = (IServiceProvider)condition;
		...
		public static IValidationError AddError<TValidationComponent, TArgument>(this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage<TArgument>> selector, TArgument argument)
			where TValidationComponent : IValidationComponent
		{
			var provider = (IServiceProvider)condition;
		...
		public static IValidationError AddWarning<TValidationComponent, TArgument>(this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage<TArgument>> selector, TArgument argument)
			where TValidationComponent : IValidationComponent
		{
			var provider = (IServiceProvider)condition;
		...
		public static IValidationError AddInformation<TValidationComponent, TArgument>(this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage<TArgument>> selector, TArgument argument)
			where TValidationComponent : IValidationComponent
		{
			var provider = (IServiceProvider)condition;
		...
		public static IValidationError AddDebug<TValidationComponent, TArgument>(this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage<TArgument>> selector, TArgument argument)
			where TValidationComponent : IValidationComponent
		{
			var provider = (IServiceProvider)condition;
		...
		public static IValidationError AddTrace<TValidationComponent, TArgument>(this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage<TArgument>> selector, TArgument argument)
			where TValidationComponent : IValidationComponent
		{
			var provider = (IServiceProvider)condition;
		...
		public static IValidationError AddError<TValidationComponent, TArgument1, TArgument2>(
			...
			Func<TValidationComponent, ValidationMessage<TArgument1, TArgument2>> selector, TArgument1 argument1,
		...
		public static IValidationError AddError<TValidationComponent, TArgument1, TArgument2, TArgument3>(
			this IValidationCondition condition,
			Func<TValidationComponent, ValidationMessage<TArgument1, TArgument2, TArgument3>> selector, TArgument1 argument1,
